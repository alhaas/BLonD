...
#
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.cbEnergy.setCurrentText(_translate("mainWindow", "FCC"))
        self.cbMachine.setItemText(0, _translate("mainWindow", "FCC"))
        self.cbMachine.setItemText(1, _translate("mainWindow", "LHC"))
        self.cbMachine.setItemText(2, _translate("mainWindow", "PSB"))
        self.cbMachine.setItemText(3, _translate("mainWindow", "SPS, Q20"))
        self.cbMachine.setItemText(4, _translate("mainWindow", "SPS, Q26"))
        self.cbMachine.setItemText(5, _translate("mainWindow", "CPS"))
...
#         self.tb1.append('bunch_length_target is ' + self.bunch_length_target)
        ...
        gamma_ts = {'PSB': 4.0767, 'CPS': np.sqrt(37.2), 'SPS, Q20': 18.,
                   'SPS, Q26': 22.83, 'LHC': 55.759505, 'FCC':99.331758}
        harmonics = {'PSB': 1, 'CPS': 21, 'SPS, Q20': 4620, 'SPS, Q26': 4620,
                     'LHC': 35640, 'FCC': 130680}
        circumferences = {'PSB': 2 * np.pi * 25, 'CPS': 2 * np.pi * 100.,
                          'SPS, Q20': 2 * np.pi * 1100.009,'SPS, Q26': 2 * np.pi * 1100.009,
                          'LHC': 26658.883, 'FCC': 97749.141}
        energies_fb = {'PSB': (50.e6 + m_p * c ** 2 / e), 'CPS': 1.4e9, 'SPS, Q20': 25.94e9,
                       'SPS-Q26': 25.94e9, 'LHC': 450.e9, 'FCC': 3.3e12}
        energies_ft = {'PSB': (1.4e9 + m_p * c ** 2 / e), 'CPS': 25.92e9, 'SPS, Q20': 450.e9,
                       'SPS, Q26': 450.e9, 'LHC': 6.5e12, 'FCC': 50e12}
        # Machine-dependent parameters [SI-units] -----------------------------
